...
<style>
    ...
    .faculty-logo-list {
        display: grid;
        /* Updated: Use a 7-column grid for 14 faculties (2 rows x 7 columns) */
    ...
    @media (max-width: 991px) {
        ...
        /* On mobile: show 4 columns instead of 7 */
        .faculty-logo-list {
    ...
    @media (max-width: 576px) {
        /* On small mobile: show 3 columns */
        .faculty-logo-list {
            ...
            <div class="faculty-logo-list">
                <c:forEach var="faculty" items="${faculties}" varStatus="loop">
                    <div class="faculty-logo-item" 
                         data-logo="${pageContext.request.contextPath}/${not empty faculty.logoUrl ? faculty.logoUrl : 'assets/img/logo-placeholder.png'}"
                         data-name="${faculty.name}"
                         data-link="${pageContext.request.contextPath}/faculty?id=${faculty.id}">
                        <img src="${pageContext.request.contextPath}/${not empty faculty.logoUrl ? faculty.logoUrl : 'assets/img/logo-placeholder.png'}" alt="Logo ${faculty.name}">
                    </div>
                </c:forEach>
            </div>
