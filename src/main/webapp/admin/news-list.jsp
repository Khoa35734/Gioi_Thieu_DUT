...
<head>
    ...
    <title>Quản lý Bài viết - Super Admin Dashboard</title>
        ...
        <div class="content-area">
            ...
            <div class="card">
                <div class="card-header">
                    <h5><i class="bi bi-newspaper me-2"></i>Danh sách Bài viết</h5>
                    ...
                    <c:choose>
                        <c:when test="${empty newsList}">
                            <div class="empty-state">
                                ...
                                <p>Hãy tạo bài viết đầu tiên cho hệ thống</p>
                                <a href="${pageContext.request.contextPath}/admin/news?action=new" class="btn btn-success mt-3">
